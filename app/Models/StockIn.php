...
#[Fillable(['reference_no', 'warehouse_id', 'transaction_date', 'status', 'remark', 'created_by'])]
class StockIn extends Model implements AuditableContract
{
    use Auditable;
    ...
    protected function casts(): array
    {
        return [
            ...
            'status' => StockInStatusEnum::class,
        ];
    }
